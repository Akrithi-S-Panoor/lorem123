...
//    }
    ...
    {
        Map<Integer,List<offerSelectiveFields>> offerList=userservice.viewBestOffers(page);
        if(offerList==null)
        {
    ...
    public ResponseEntity<?> viewAllOffers(@RequestParam int page)
    {
        ...
        Map<Integer,List<offerSelectiveFields>> offerList=userservice.viewAllOffers(page);
        if(offerList==null)
        {
            return  new ResponseEntity<>("No offers ahead",HttpStatus.FORBIDDEN);
        }
    ...
    {
        Map<Integer,List<offerSelectiveFields>> offerList=userservice.viewBrandOffers(brandID,page);
        if(offerList==null)
        {
    ...
    public ResponseEntity<?> getRestaurantOffers(@RequestParam int page, @RequestParam int restaurantId)
    {
        ...
        Map<Integer,List<offerSelectiveFields>> offers= userservice.viewBestOfferOfRestaurant(page,restaurantId);
    ...
    public ResponseEntity<?> getRestaurantAllOffers(@RequestParam int page, @RequestParam int restaurantId)
    {
        ...
        Map<Integer,List<offerSelectiveFields>> offers= userservice.viewAllOffersOfRestaurant(page,restaurantId);
